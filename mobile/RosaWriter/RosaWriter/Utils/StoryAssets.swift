...
extension CharacterVoice {
  ...
  static let playful = CharacterVoice(
    ...
    thinking: [
      "Hmm... what if we tried something silly?", "I've got a funny idea!",
      "Let me thinkety-think.",
    ],
  ...
  static let thoughtful = CharacterVoice(
    ...
    thinking: [
      "Let's consider the clues.", "There must be another way.", "I need a moment to think.",
    ],
  ...
  static let formal = CharacterVoice(
    ...
    thinking: [
      "Let us consider this carefully.", "Perhaps another approach is in order.",
      "I have a thought.",
    ],
  ...
  static let bold = CharacterVoice(
    ...
    thinking: [
      "Let's make a plan.", "There has to be a way through.", "What would a brave friend do?",
    ],
...
struct StoryObject {
  ...
  init(
    ...
    if let articleForm = displayNameWithArticle,
      !articleForm.trimmingCharacters(in: .whitespaces).isEmpty
    {
