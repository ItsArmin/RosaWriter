    ...
    Button(action: onTap) {
      VStack(spacing: BookCoverConstants.titleSpacing) {
        ...
        ZStack(alignment: .leading) {
          ...
          VStack(spacing: 0) {
            Rectangle()
              ...
              .frame(width: BookCoverConstants.spineWidth, height: BookCoverConstants.coverHeight)
              .overlay(
                // Spine highlights
                Rectangle()
                  .fill(
          ...
          ZStack {
            ...
            BookCoverShape(cornerRadius: BookCoverConstants.cornerRadius)
              .fill(
                LinearGradient(
                  colors: [
            ...
            if let imageName = coverImageName {
              Image(imageName)
                ...
                .clipShape(BookCoverShape(cornerRadius: BookCoverConstants.cornerRadius))
            } else {
            ...
            Rectangle()
              ...
              .offset(
                x: -(BookCoverConstants.coverWidth / 2 - BookCoverConstants.innerShadowWidth / 2))
          }
          .frame(width: BookCoverConstants.coverWidth, height: BookCoverConstants.coverHeight)
          .offset(x: BookCoverConstants.spineWidth)
          .shadow(color: .black.opacity(0.3), radius: 8, x: 4, y: 4)
        }
        .frame(width: BookCoverConstants.totalWidth, height: BookCoverConstants.coverHeight)
        ...
        Text(book.title)
          ...
          .frame(
            width: BookCoverConstants.totalWidth, height: BookCoverConstants.titleHeight,
            alignment: .top)
      }
    }
